    ...
    return (
        ...
        >
            <div className="flex justify-between items-start">
                <h3 className="font-medium text-blue-400 hover:underline underline-offset-4 cursor-pointer">
                    {project.title}
                </h3>
                <div className="flex items-center gap-1 text-xs text-yellow-400">
                    <Star size={20} className="w-4 h-4" />
                    <span className="font-semibold text-sm">{project.stars.length}</span>
                </div>
            </div>
